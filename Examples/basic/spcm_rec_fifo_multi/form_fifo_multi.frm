VERSION 5.00
Begin VB.Form form_fifo_multi 
   BackColor       =   &H8000000A&
   Caption         =   "Fifo Multi Example"
   ClientHeight    =   2835
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5295
   ...
   End
End
Attribute VB_Name = "form_fifo_multi"
...
Private Sub ButtonStart_Click()
    ...
    ' ----- setup board -----
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_CARDMODE, SPC_REC_FIFO_MULTI)
    ...
    lError = spcm_dwSetParam_i64m(g_hDevice, SPC_POSTTRIGGER, 0, 896)
    ...
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_EXTERNOUT, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_EXT0_MODE, SPC_TM_POS)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_EXT0_PULSEWIDTH, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIGGEROUT, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIGGER50OHM, 1)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_ORMASK, SPC_TMASK_EXT0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_ANDMASK, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_CH_ORMASK0, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_CH_ORMASK1, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_CH_ANDMASK0, 0)
    lError = spcm_dwSetParam_i32(g_hDevice, SPC_TRIG_CH_ANDMASK1, 0)
    ...
    While (g_bStop = False)
        ...
        ' ----- set timeout -----
        lError = spcm_dwSetParam_i32(g_hDevice, SPC_TIMEOUT, 5000)
