%**************************************************************************
%
% rep_std_single.m                              (c) Spectrum GmbH, 2018
%
%**************************************************************************
%
...
if cardInfo.cardFunction == mRegs('SPCM_TYPE_AO')
    ...
    if cardInfo.setChannels == 8
        % use signals from ch0 - ch3 also for ch4 - ch7
        Dat_Ch4 = Dat_Ch0;
        Dat_Ch5 = Dat_Ch1;
        Dat_Ch6 = Dat_Ch2;
        Dat_Ch7 = Dat_Ch3;
    ...
    switch cardInfo.setChannels
        ...
        case 8
            % ----- set data for eight channels with offset = 0 ----- 
            errorCode = spcm_dwSetData (cardInfo.hDrv, 0, cardInfo.setMemsize, cardInfo.setChannels, 0, Dat_Ch0, Dat_Ch1, Dat_Ch2, Dat_Ch3, Dat_Ch4, Dat_Ch5, Dat_Ch6, Dat_Ch7);
    end
