...
function [success, cardInfo] = spcMInitDevice (deviceString)
    ...
    [errorCode, cardInfo.extFeatureMap]  = spcm_dwGetParam_i32 (cardInfo.hDrv, mRegs('SPC_PCIEXTFEATURES'));
    ...
    switch cardInfo.cardFunction
        ...
        case mRegs('SPCM_TYPE_AI')
			...
			if bitand (AIFeatures, mRegs('SPCM_AI_DIFFMUX')) ~= 0
                cardInfo.AI.diffMuxModeAvailable = 1;
            else
                cardInfo.AI.diffMuxModeAvailable = 0;
            end
